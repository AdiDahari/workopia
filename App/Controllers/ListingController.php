...
class ListingController
{
  ...
  public function search()
  {
    ...
    $query = "SELECT * FROM listings WHERE (title LIKE :keywords OR description LIKE :keywords OR company LIKE :keywords) AND (city LIKE :location OR state LIKE :location OR country LIKE :location)";
